...
<body>
  ...
  <form action="ctrl.filehandler.php" method="post" id="theform">
      ...
      <label for="functie">functie</label>
        ...
        <br>  <br> 
        <label for="fileContent">cursus</label>
        <textarea id="mytextarea" rows="4" cols="50" name="fileContent"></textarea>
        <label for="fileName">periode</label>
        <input type="month" name="fileName" placeholder="File Name" value="">
        <label for="fileName">behaald?</label>
        <select class="midden" id="form"  form="form">
        <option  class="midden" >niet behaald</option>
        <option  class="midden" >behaald</option>
        
        </select>

        <a class="nav-link align" href="./stages.php">volgende </a>
        </form>
